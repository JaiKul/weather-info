          ...
          <v-list subheader>
            ...
            <v-list-item>
              ...
              <v-list-item-content>
                ...
                <v-list-item-subtitle>Current Temperature</v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item>
            <v-list-item>
              <v-list-item-icon>
        ...
        <v-card>
          <v-list subheader>
            ...
            <v-list-item>
              ...
              <v-list-item-content>
                <v-list-item-title>{{ details.visibility }}</v-list-item-title>
...
export default {
  ...
  computed: {
    details() {
      return this.$store.getters.cityWeatherDetails;
    },
    sunrise() {
